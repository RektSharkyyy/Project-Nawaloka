#!/usr/bin/env python3
"""
Heshan AI Project Template Generator

Generates a production-ready project structure following the
Heshan AI Standard.
...
Production-ready RAG system following Heshan AI Standard.

## Features

- ✅ Heshan AI structure (Application/Domain/Infrastructure)
...
def generate_project(
    ...
    """
    print("=" * 80)
    print(f"🏗️  GENERATING HESHAN AI PROJECT STRUCTURE")
    print("=" * 80)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate Heshan AI project structure",
